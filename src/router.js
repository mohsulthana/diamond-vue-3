...
const routes = [
    ...
    },
    {
        ...
        meta: {
            breadcrumb: [{ parent: 'UI Kit', label: 'Gantt Chart' }],
        },
    },
    {
        path: '/tree',
    ...
    },
    {
        ...
        meta: {
            breadcrumb: [{ parent: 'Pages', label: 'Schedule View' }],
        },
    },
    {
        path: '/invoice-summary',
        name: 'invoice-summary',
        component: () => import('./components/InvoiceSummary.vue'),
        meta: {
            breadcrumb: [{ parent: 'Pages', label: 'Invoice Summary' }],
        },
    },
    {
        path: '/login',
