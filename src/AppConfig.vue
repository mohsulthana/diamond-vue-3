<template>
    <div id="layout-config">
        ...
        <div class="layout-config" :class="{ 'layout-config-active': configActive }" @click="onConfigClick">
            ...
            <h5>Menu Themes</h5>
            <div class="layout-themes" v-if="d_colorScheme === 'light' && d_menuMode !== 'horizontal'">
            ...
            <div v-if="d_colorScheme !== 'light' || d_menuMode === 'horizontal'">
...
export default {
    ...
    methods: {
        ...
        changeMenuMode(mode) {
            ...
            this.$emit("update:menuTheme", this.d_menuTheme);
        },
