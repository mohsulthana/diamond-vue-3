    ...
    data() {
        return {
            ...
            menu: [
                // {
                //     items: [
                //         {label: "Headquarters", icon: "pi pi-fw pi-globe", to: "/"},
                //     ],
                // },
                // {
                //     label: "Accounts", icon: "pi pi-fw pi-user",
                //     items: [
                //         {label: "Manager", icon: "pi pi-fw pi-user", to: "/"},
                //         {label: "Consultant", icon: "pi pi-fw pi-user", to: "/"},
                //     ],
                // },
                // {
                //     label: "Schedule", icon: "pi pi-fw pi-calendar",
                //     items: [
                //         {label: "View", icon: "pi pi-fw pi-calendar-plus", to: "/schedule-view"},
                //         {label: "Configure", icon: "pi pi-fw pi-calendar", to: "/"},
                //     ],
                // },
                // {
                //     label: "Invoices", icon: "pi pi-fw pi-copy",
                //     items: [
                //         {label: "Summary", icon: "pi pi-fw pi-copy", to: "/invoice-summary"},
                //         {label: "Queue", icon: "pi pi-fw pi-copy", to: "/"},
                //     ],
                // },
                // {
                //     label: "Reports", icon: "pi pi-fw pi-chart-bar",
                //     items: [
                //         {label: "View", icon: "pi pi-fw pi-chart-bar", to: "/"},
                //         {label: "Export", icon: "pi pi-fw pi-chart-bar", to: "/"},
                //     ],
                // },
                // { separator: true },
                // {
                ...
                // { separator: true },
                {
                    items: [
                        ...
                        },
                        {
                            label: "Invoices", icon: "pi pi-fw pi-copy",
                            items: [
                                {label: "Summary", to: "/invoice-summary"},
                                {label: "Queue"},
                            ]
                        },
                        {
